<img src="icons/logo_web_512.png" alt="logo" width="200" height="200">

# Prompt Pile

**Prompt Pile** is a streamlined sidebar browser extension designed to save and organize AI prompts. Regardless of whatever model you are currently using, this tool helps maintain a personal library of high-performing prompts to optimize your AI interactions.
...
* [**Chrome Web Store**](https://chromewebstore.google.com/detail/prompt-pile/akgbknmfalamjbloabkcgpdnpgeegnnm)
* [**Firefox Add-ons**](https://addons.mozilla.org/en-US/firefox/addon/prompt-pile/)
